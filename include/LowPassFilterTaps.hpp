...
namespace LowPassTaps {
    ...
    template<>
    constexpr auto getTaps<Rate_2_4_Mhz, Rate_8_0_Mhz>(){
        // Best params: [1.0984033074792499, 0.32747604914658046, -0.23215100276272754, 0.9754533083166583, -0.005237108430516252, 0.4850827008243599, 0.27467233222606, 0.4276856379263376, 0.8201596909557252]
    ...
    template<>
    constexpr auto getTaps<Rate_2_56_Mhz, Rate_8_0_Mhz>(){
        return std::to_array<float>({
            -0.008058671839535236,
            -0.0025700803380459547,
            0.027480756863951683,
            0.029833784326910973,
            0.05584562197327614,
            0.10413344949483871,
            0.060713447630405426,
            0.4652433693408966,
            0.060713447630405426,
            0.10413344949483871,
            0.05584562197327614,
