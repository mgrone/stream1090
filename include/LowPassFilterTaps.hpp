...
namespace LowPassTaps {
    ...
    constexpr auto getTaps<Rate_2_4_Mhz, Rate_8_0_Mhz>(){
        // seed: [0.1124400431237176, 0.2945768572815861, 0.4467455514322548, -0.15850105688460994, 0.7284096361116326]
        return std::to_array<float>({
            -0.0023765000514686108,
            -0.0075556496158242226,
            0.04378686472773552,
            0.006867857649922371,
            0.06030089408159256,
            0.08393791317939758,
            0.06814586371183395,
            0.4937855899333954,
